...
namespace TShop.Api.Migrations
{
    ...
    [Migration("20221207075731_AddIndentityFeature")]
    partial class AddIndentityFeature
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TShop.Api.Models.Brand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 12, 7, 7, 57, 30, 971, DateTimeKind.Utc).AddTicks(4224),
                            Name = "Sexy Forever",
                            Status = 0,
                            Summary = "Sexy Forever",
                            UpdatedBy = "Tam Nguyen",
                            UpdatedDate = new DateTime(2022, 12, 7, 7, 57, 30, 971, DateTimeKind.Utc).AddTicks(4224)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("TShop.Api.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Tam Nguyen",
                            CreatedDate = new DateTime(2022, 12, 7, 7, 57, 30, 971, DateTimeKind.Utc).AddTicks(3944),
                            Description = "",
                            Name = "Thời trang nam",
                            SeoUrl = "thoi-trang-nam",
                            Status = 0,
                            UpdatedBy = "Tam Nguyen",
                            UpdatedDate = new DateTime(2022, 12, 7, 7, 57, 30, 971, DateTimeKind.Utc).AddTicks(3944)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("TShop.Api.Models.Tag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Tam Nguyen",
                            CreatedDate = new DateTime(2022, 12, 7, 7, 57, 30, 971, DateTimeKind.Utc).AddTicks(4266),
                            Slug = "quan-ao",
                            Status = 0,
                            Title = "Quần áo",
                            UpdatedBy = "Tam Nguyen",
                            UpdatedDate = new DateTime(2022, 12, 7, 7, 57, 30, 971, DateTimeKind.Utc).AddTicks(4266)
                        },
                        new
                        {
                            Id = 2,
